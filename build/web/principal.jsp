    ...
    <body>
            ...
            <div class="cont-menu">
                <nav>
                    ...
                    <%
                        ...
                        List<Usuario> listaUs = conexion.mostrarId(idUs);
                    %>
                    <div class="imagenE">
                        <div class="imgOp">
                            <img id="perfFoto" src="MostrarFoto?id=<%= listaUs.get(0).getId()%>">
                        </div>
                        <div>
                            <a href="modificar.jsp"><%= listaUs.get(0).getUsuario()%></a>                            
                        </div>
                    </div>
                    <div class="imagenE">
                        <div class="imgOp">
        ...
        <main>
            ...
            <%
                ...
                List<Publicacion> lista = conexion.mostrarIdP();
            ...
            <section class="completo">
                <div class="container">
                    <section>
                        ...
                        <div class="nomEmp">
                            <a href="local_principal.jsp?nameE=<%= listaE.get(0).getNombre_empresa() %>&&e=<%= idE %>"> <img id="perfFoto" src="MostrarFotoE?id=<%= listaE.get(0).getId()%>">    </a>                            
                            <p>
                        ...
                        <div class="publicacion">
                            ...
                            <div class="formi">
                                ...
                                <form action="Comentar" method="POST" id="formulario">
                                    <input type="text" name="comentario" id="comentario" placeholder="Agrega tu comentario">
                                    <input type="text" name="publicacion" id="publicacion" style="visibility: hidden" value=<%= lista.get(i).getId_publicacion()%>>
                        ...
                        <div class="comentarios">
                            ...
                            <div class="formComentarios">
                                <div class="fotoPerfil">
                                    <img id="perfFoto" src="MostrarFoto?id=<%= listaP.get(y).getId_usuario1() %>">
                                </div>
                                <div class="informacion">
                                    <div class="datos">
                                        <div class="nombre">
                                            <label for=""><%= listaP.get(y).getUsuario() %></label>
                                        </div>
                                        <div class="fecha">
